...
execute as @e[nbt={Item:{id:"minecraft:crafting_table",tag:{Creation_table_item:1b}}}] run execute as @e[tag=Creation_Table, limit=1, distance=..2] run data modify entity @s Rotation set from entity @p Rotation
execute as @e[nbt={Item:{id:"minecraft:crafting_table",tag:{Creation_table_item:1b}}}] run execute as @e[tag=Creation_Table, limit=1, distance=..2] at @s run teleport @s ~ ~ ~ ~ 90
